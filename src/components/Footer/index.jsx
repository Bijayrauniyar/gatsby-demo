            ...
            <main>
              ...
              <footer className='site-footer'>
                <div className='social footer-social'>
                  <ul>
                    <li>
                      <a href='https://twitter.com/danfebooks' target='_blank'>
                        <svg
                ...
                <div className='footer-text'>
                  <p>
                    Made with
                    {' '}
                    <span style={{ color: '#e20202' }}>❤️</span>
                    {' '}
                    in Nepal
                  </p>
                  <p>
                    Copyright &copy; 2016 - 2019 - Danfe Creatives Pvt. Ltd. |
                    {' '}
                    <a
                      style={{ textDecoration: 'underline' }}
                      href='mailto:humans@danfebooks.com'
                    >
                      humans@danfebooks.com
                    </a>
                    Phone: +977-01-4000099 (8:00AM - 5:00PM)
                  </p>
                  <p>
                    <small>
                      ...
                      |
                      {' '}
                      <a href='/terms-of-service.html?utl_medium=LandingFooterLink'>
                        Terms of Services
                      </a>
                      {' '}
                      |
                      {' '}
                      <a href='/'>danfebooks&reg;</a>
                      {' '}
                      is a registered property
                      of
                      {' '}
                      <a href='https://www.danfecreatives.com/'>
